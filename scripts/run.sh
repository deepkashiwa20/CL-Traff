...
python traintest_MemGCRN.py --lamb 0.01 --temp 0.1   worse than baseline (contra_denominator=False or True is same)
...
# python traintest_MemGCRN.py --temp 0.1 --lamb 0.01    worse than baseline (contra_denominator=False or True is same)
