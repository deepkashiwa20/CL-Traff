...
def traintest_model():
    ...
    for epoch_num in range(args.epochs):
        ...
        for x, y in data_iter:
            ...
            query_simi = torch.cosine_similarity(Q_t, Q_his, dim=-1)
            ...
            loss = mae_loss + args.lamb_xq * loss_xq
        ...
        end_time2 = time.time()
        message = "Epoch [{}/{}] loss: {:.4f}, mae_loss: {:.4f}, XQ_loss: {:.4f}, val_loss: {:.4f}, lr: {:.6f}, {:.1f}s".format(
            epoch_num + 1,
            args.epochs,
            train_loss,
            train_mae_loss,
