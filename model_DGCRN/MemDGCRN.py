...
class MemDGCRN(nn.Module):
    ...
    def forward(self, x, y_cov, labels=None, batches_seen=None):
        ...
        # node_embeddings = self.hypernet(h_t) # self.hypernet should be revised
        # node_embeddings = self.hypernet(h_aug) # self.hypernet should be revised
        # node_embeddings = self.hypernet(pos) # self.hypernet should be revised
