...
def get_model():
    if args.adj_mx:
        ...
        adjs = None
    model = MGCRN(num_nodes=args.num_nodes, input_dim=args.input_dim, output_dim=args.output_dim, horizon=args.horizon, 
...
parser.add_argument("--adj_mx", type=eval, choices=[True, False], default='True', help="use predefined adj_mx")
parser.add_argument("--adj_type", type=str, default='symnadj', help="symnadj, transition, doubletransition")
