...
def generate_train_val_test(args):
    ...
    # data = np.load("./PEMSD7L/PEMSD7L.npz")["data"]
    ...
    start_dates = {
        ...
        "PEMSD7L": "2012-05-01 00:00:00",
        "PEMSD7M": "2012-05-01 00:00:00",
    ...
    end_dates = {
        ...
        "PEMSD7L": "2012-06-30 23:55:00",
        "PEMSD7M": "2012-06-30 23:55:00",
    ...
    train_dates = {
        ...
        "PEMSD7L": "2012-06-18 23:55:00",
        "PEMSD7M": "2012-06-18 23:55:00",
    }
    weekdays = pd.date_range(start=start_dates[dataset_name], end=end_dates[dataset_name], freq="5min")
    weekdays_1 = weekdays[:288 * 4]
    weekdays_2 = weekdays[288 * 7 * 1 - 288:288 * 7 * 1 + 288 * 4]
    weekdays_3 = weekdays[288 * 7 * 2 - 288:288 * 7 * 2 + 288 * 4]
    weekdays_4 = weekdays[288 * 7 * 3 - 288:288 * 7 * 3 + 288 * 4]
    weekdays_5 = weekdays[288 * 7 * 4 - 288:288 * 7 * 4 + 288 * 4]
    weekdays_6 = weekdays[288 * 7 * 5 - 288:288 * 7 * 5 + 288 * 4]
    weekdays_7 = weekdays[288 * 7 * 6 - 288:288 * 7 * 6 + 288 * 4]
    weekdays_8 = weekdays[288 * 7 * 7 - 288:288 * 7 * 7 + 288 * 4]
    weekdays_9 = weekdays[288 * 7 * 8 - 288:288 * 7 * 8 + 288 * 4]
    # weekdays_5=weekdays[288*7*4+288:288*7*4+288*5]
    # print(weekdays_9[:10])
    timeslots = np.concatenate([weekdays_1, weekdays_2, weekdays_3, weekdays_4, weekdays_5, weekdays_6
                                  , weekdays_7, weekdays_8, weekdays_9])
    print(len(timeslots))
...
if __name__ == "__main__":
    ...
    parser.add_argument('--dataset', type=str, choices=['PEMS03','PEMS04','PEMS07', 'PEMS08','PEMSD7L','PEMSD7M'], default='PEMSD7M', help='which dataset to run')
    parser.add_argument("--output_dir", type=str, default="PEMSD7M/", help="Output directory.")
