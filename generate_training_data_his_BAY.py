...
def generate_train_val_test(args):
    df = pd.HDFStore(args.traffic_df_filename)['/speed']
...
if __name__ == "__main__":
    ...
    parser.add_argument("--output_dir", type=str, default="PEMSBAY/", help="Output directory.")
