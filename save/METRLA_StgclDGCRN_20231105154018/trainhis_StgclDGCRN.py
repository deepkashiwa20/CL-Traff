...
from StgclDGCRN import StgclDGCRN 
...
def get_model():  
    model = StgclDGCRN(num_nodes=args.num_nodes, input_dim=args.input_dim, output_dim=args.output_dim, horizon=args.horizon, 
...
parser.add_argument('--schema', type=int, default=2, choices=[0, 1, 2, 3, 4, 5], help='which contra backbone schema to use (0 is no contrast, i.e., baseline)')
